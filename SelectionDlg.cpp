...
Message gameMessages[GAME_MESSAGE_COUNT] = {
	{170, _TEXT("专家提议提高大学生“动手素质”，进口玩具颇受欢迎!"), 5, 2, 0, 0},
	{139, _TEXT("有人自豪地说：生病不用打针吃药，喝假白酒（剧毒）就可以!"), 3, 3, 0, 0},
	{100, _TEXT("医院的秘密报告：“《上海小宝贝》功效甚过伟哥”!"), 4, 5, 0, 0},
	{41,  _TEXT("文盲说：“2000年诺贝尔文学奖？呸！不如盗版VCD港台片。”"), 2, 4, 0, 0},
	{37,  _TEXT("《北京经济小报》社论：“走私汽车大力推进汽车消费!”"), 1, 3, 0, 0},
	{23,  _TEXT("《北京真理报》社论：“提倡爱美，落到实处”，伪劣化妆品大受欢迎!"), 7, 4, 0, 0},
	{37,  _TEXT("8858.com电子书店也不敢卖《上海小宝贝》，黑市一册可卖天价!"), 4, 8, 0, 0},
	{15,  _TEXT("谢不疯在晚会上说：“我酷!我使用伪劣化妆品!”，伪劣化妆品供不应求!"), 7, 7, 0, 0},
	{40,  _TEXT("北京有人狂饮山西假酒，可以卖出天价!"), 3, 7, 0, 0},
	{29,  _TEXT("北京的大学生们开始找工作，水货手机大受欢迎！!"), 6, 7, 0, 0},
	{35,  _TEXT("北京的富人疯狂地购买走私汽车！价格狂升!"), 1, 8, 0, 0},
	{17,  _TEXT("市场上充斥着来自福建的走私香烟!"), 0, 0, 8, 0},
	{24,  _TEXT("北京的孩子们都忙于上网学习，进口玩具没人愿意买。"), 5, 0, 5, 0},
	{18,  _TEXT("盗版业十分兴旺，“中国硅谷”——中关村全是卖盗版VCD的村姑!"), 2, 0, 8, 0},
	{160, _TEXT("厦门的老同学资助俺两部走私汽车！发了！！"), 1, 0, 0, 2},
	{45,  _TEXT("工商局扫荡后，俺在黑暗角落里发现了老乡丢失的进口香烟。"), 0, 0, 0, 6},
	{35,  _TEXT("俺老乡回家前把一些山西假白酒（剧毒）给俺!"), 3, 0, 0, 4},
	{140, _TEXT("媒体报道：又有日本出口到中国的产品出事了! 出事后日本人死不认帐,拒绝赔偿。村长得知此消息，托人把他用的水货手机（无任何厂商标识）硬卖给您，收您2500元。"),6,0,0,1}
};
...
BadEvent random_event[EVENT_CNT] = {
	{117, _TEXT("大街上两个流氓打了俺!"), 3,_TEXT("kill.wav")},
	{157, _TEXT("俺在过街地道被人打了蒙棍! "), 20,_TEXT("death.wav")},
	{21,  _TEXT("工商局的追俺超过三个胡同。 "),1,_TEXT("dog.wav")},
	{100, _TEXT("北京拥挤的交通让俺心焦! "),1,_TEXT("harley.wav")},
	{35,  _TEXT("开小巴的打俺一耳光!"),1,_TEXT("hit.wav")},
	{313, _TEXT("一群民工打了俺!"), 10,_TEXT("flee.wav")},
	{120, _TEXT("附近胡同的一个小青年砸俺一砖头!"), 5,_TEXT("death.wav")},
	{29,  _TEXT("附近写字楼一个假保安用电棍电击俺!"),3,_TEXT("el.wav")},
	{43,  _TEXT("北京臭黑的小河熏着我了! "),1,_TEXT("vomit.wav")},
	{45,  _TEXT("守自行车的王大婶嘲笑俺没北京户口!"),1,_TEXT("level.wav")},
	{48,  _TEXT("北京高温40度!俺热..."),1,_TEXT("lan.wav")},
	{33,  _TEXT("申奥添了新风景，北京又来沙尘暴!"),1,_TEXT("breath.wav")}
};
...
StealEvent random_steal_event[STEAL_EVENT_CNT] = {
	...
	{60,  _TEXT("俺怜悯地铁口扮演成乞丐的老太太。"), 10},
	{125, _TEXT("一个汉子在街头拦住俺：“哥们，给点钱用!”。"),10},
	{100, _TEXT("一个大个子碰了俺一下，说：“别挤了!”。"),40},
	{65,  _TEXT("三个带红袖章的老太太揪住俺：“你是外地人?罚款!”"),20},
	{35,  _TEXT("两个猛男揪住俺：“交长话附加费、上网费。”"), 15},
	{27,  _TEXT("副主任说：“办经商证?晚上不要去我家给我送钱哦。”"), 10},
	{40,  _TEXT("北京空气污染得厉害,俺去氧吧吸氧..."), 5}
};
...
CAboutDlg::CAboutDlg() : CDialog(CAboutDlg::IDD)
{
	...
	CString cs = _TEXT("作者：郭祥昊，男，1970年4月生，1998年毕业于北京邮电大学，获博士学位，专业：人工智能与自然语言处理。热爱游戏到了自己开发的地步。");
	CString cs1 = _TEXT("");
	//}}AFX_DATA_INIT
}
...
void CAboutDlg::OnDoubleclickedAuthor()
{
	...
	AfxMessageBox(_TEXT("Programmed by Guo xianghao(guoxh@hotmail.com)2000/12"));
}
...
void CAboutDlg::OnRButtonDown(UINT nFlags, CPoint point)
{
	...
	static int i = 0;
	CString cs1 = _TEXT("作者：郭祥昊，男，1970年4月生，1998年毕业于北京邮电大学，获博士学位，专业：人工智能与自然语言处理。目前从事自然语言处理研究，开发软件。热爱游戏到了自己开发的地步。在北京浮生超过10年。");
	CString cs2 = _TEXT("我爱自然，艺术、文学。编程序主要使用C/C++,但是对80x86汇编语言也非常熟悉，曾经给女朋友（现在是我孩子的妈）编过一个计算机病毒。我还精通LISP和Prolog语言，对信息检索技术和概念检索技术有很深入的研究。");
	i += 1;
	if (i > 5)
	{
		if (i > 10)
...
BOOL CSelectionDlg::OnInitDialog()
{
	...
	m_list1.InsertColumn(0, _TEXT("商品"), LVCFMT_LEFT, 68);
	m_list1.InsertColumn(1, _TEXT("黑市价格"), LVCFMT_LEFT, 67);
	m_list1.InsertColumn(2, _TEXT(""), LVCFMT_LEFT, 27);
	// create house column
	m_list2.InsertColumn(0, _TEXT("商品"), LVCFMT_LEFT, 68);
	m_list2.InsertColumn(1, _TEXT("买进价格"), LVCFMT_LEFT, 67);
	m_list2.InsertColumn(2, _TEXT("数量"), LVCFMT_LEFT, 57);

	// add some items
	for (int i = 0; i < 1; i++)
	{
		CString str;
		str.Format(_TEXT("(%03d , "), i);
		int n = m_list1.InsertItem(i, str + _TEXT("01)"), 0);
		m_list1.SetItemText(n, 1, str + _TEXT("02)"));
		m_list1.SetItemText(n, 2, str + _TEXT("03)"));
	}
	m_nBuyCount = 0;
	m_nSellCount = 0;
	...
	m_sTicker.SetTickerText(_TEXT(" Loading data, please wait..."));
	//IMPORTANT CALL to set the Window Coordinates of the Ticker
	m_sTicker.GetWindowRect(&m_TickerRect);
	m_sTicker.ShowRates(_TEXT("Ticker.txt"), RGB(255, 255, 255), RGB(255, 255, 43), _TEXT("Comic Sans MS"), 17, 4, MODE_RATES_TICKER);
...
void CSelectionDlg::OnAdd()
{
	...
	{
		CRijiDlg dlg(NULL, _TEXT("我还没有选定买什么物品呢。"));
		dlg.DoModal();
		RefreshDisplay();
		return;
	}
	...
	if (MyCash < price) {
		if (MyBank > 0) {
			CRijiDlg dlg(NULL, _TEXT("俺带的现金不够，去银行提点钱吧。"));
			dlg.DoModal();
		}
		else
		{
			CRijiDlg dlg(NULL, _TEXT("俺的现金不够，银行又没有存款，咋办哩?"));
			dlg.DoModal();
		}
	...
	if (dlg.DoModal() == IDOK) {   //user decide to buy
		if (m_bCloseSound == FALSE)
			PlaySound(_TEXT("sound\\buy.wav"), NULL, SND_ASYNC);
...
void CSelectionDlg::MoveListItems(CListCtrl& pFromList, CListCtrl& pToList)
{
	...
	if (pFromList == m_list1) {  //buy
		...
		// well, can hold some goods there
			...
			cnt.Format(_TEXT("%d"), m_nBuyCount);
			m_list2.SetItemText(n, 2, cnt);
		}
		// no more room left for hold the goods
		else {
			CString msg;
			msg.Format(_TEXT("好可惜!俺租的房子太小，只能放%d个物品。租更大的房子?"), myCoat);
			...
			*/
			...
			if (dlg.DoModal() == IDOK) {
				...
				if (drug_name == _TEXT("《上海小宝贝》（禁书）"))
				{
					...
					str.Format(_TEXT("%ld"), m_MyFame);
					m_FameDisplay.SetText(str);

				}
				// ok, same as above
				else if (drug_name == _TEXT("假白酒（剧毒！）"))
				{
					CString fame;
					fame = _TEXT("");
					fame += _TEXT("买卖");
	...
	for (i = 0; i < GAME_MESSAGE_COUNT; i++)
	{
		if (!(RandomNum(950) % gameMessages[i].freq))
		{
			...
			if (gameMessages[i].add > 0)
			{
				...
				{
					CString msg;
					msg.Format(_TEXT("可惜!俺租的房子太小，只能放%d个物品。"), myCoat);
					CRijiDlg dlg(NULL, msg);
					dlg.DoModal();
					return;
				}
				...
				else
				{
					...
					m_list2.SetItemText(n, 1, _TEXT("0"));
					cnt.Format(_TEXT("%d"), addcount);
					m_list2.SetItemText(n, 2, cnt);
					myTotal += addcount;
				}
			}
...
void CSelectionDlg::OnLocJianguomen()
{
	...
	if (m_MyCurrentLoc != 1) {
		if (m_bCloseSound == FALSE)
			PlaySound(_TEXT("sound\\shutdoor.wav"), NULL, SND_ASYNC);
		m_MyCurrentLoc = 1;
		HandleNormalEvents();
...
void CSelectionDlg::DisplayDrugs()
{
	...
	for (i = 0; i < 8; i++)
	{
		if (m_DrugPrice[i] != 0) {
			...
			str.Format(_TEXT("%ld"), m_DrugPrice[i]);
			m_list1.SetItemText(n, 1, str);
			m_list1.SetItemText(n, 2, _TEXT(""));
			j += 1;
...
void CSelectionDlg::HandleNormalEvents()
{
	...
	if (MyDebt > 100000) {
		CRijiDlg dlg(NULL, _TEXT("俺欠钱太多，村长叫一群老乡揍了俺一顿!"));
		dlg.DoModal();
		m_nMyHealth -= 30;
		str.Format(_TEXT("%d"), m_nMyHealth);
		m_HealthDisplay.SetText(str);
		if (m_bCloseSound == FALSE)
			PlaySound(_TEXT("sound\\kill.wav"), NULL, SND_ASYNC);
	...
	if (m_nTimeLeft == 1)
	{
		...
		CRijiDlg dlg(NULL, _TEXT("俺明天回家乡，快把全部货物卖掉。"));
		dlg.DoModal();
	}
	// no day left. Should end the game
	if (m_nTimeLeft == 0)
	{
		CRijiDlg dlg(NULL, _TEXT("俺已经在北京40天了，该回去结婚去了。"));
		dlg.DoModal();
		...
		int things_left = 0;
		CString goods_left = _TEXT("系统替我卖了剩余货物: ");
		for (i = 0; i < m_list2.GetItemCount(); i++)
		{
...
void CSelectionDlg::DoRandomEvent()
{
	...
	CString coffee[30] = {
			...
			_TEXT("男厕所里"),_TEXT("电话亭里"),_TEXT("三陪女怀里"),_TEXT("出租车里"),_TEXT("小巴里"),_TEXT("美容院里"),
			_TEXT("小商亭里"),_TEXT("小商场门口"),_TEXT("民工脚下"),_TEXT("无照游商摊里"),_TEXT("草地上"),_TEXT("电线杆顶端"),
			_TEXT("小饭馆里"),_TEXT("马路边"),_TEXT("人行道上"),_TEXT("街心公园里"),_TEXT("广告牌下"),_TEXT("公共汽车站里"),
			_TEXT("长途汽车站里"),_TEXT("卖盗版游戏的旁边"),_TEXT("网络公司尸体旁边"),_TEXT("行骗的知本家旁边"),_TEXT("")
	};
	// the health events.
	for (i = 0; i < EVENT_CNT; i++)
	{
		...
		{
			str.Format(_TEXT("%s"), random_event[i].msg);
			str1.Format(_TEXT("俺的健康减少了%d点。"), random_event[i].hunt);
			str += str1;
			snd = _TEXT("sound\\");
	...
	if (m_nMyHealth < 85 && m_nTimeLeft>3) {
		...
		msg1.Format(_TEXT("好心的市民把我抬到医院，医生让我治疗%d天。"), delay_day);
		msg2 = _TEXT("由于不注意身体,我被人发现昏迷在");
		msg2 += loc[10 * (m_City - 1) + m_MyCurrentLoc - 1];
		msg2 += _TEXT("附近的");
		msg2 += coffee[RandomNum(29)];
		msg2 += _TEXT("。");
		int load = delay_day * (1000 + RandomNum(8500));
		msg3.Format(_TEXT("村长让人为我垫付了住院费用%d元。"), load);
	...
	if (m_nMyHealth < 20 && m_nMyHealth >0) {
		...
		CRijiDlg dlg(NULL, _TEXT("俺的健康..健康危机..快去医.."));
		dlg.DoModal();
		return;
	}
...
void CSelectionDlg::OnHospital()
{
	...
	if (m_nMyHealth < 100) {
		CString str;
		str.Format(_TEXT("大夫高兴地拍着手：“您的健康点数是%d，需要治疗的点数是%d。"),
...
{
	// TODO: Add your control notification handler code here
	//ShellExecute(0 ,_TEXT("open"), _TEXT("http://www.beijing.gov.cn/chinese/index.asp"), NULL, NULL, SW_MAXIMIZE);
	if (m_bCloseSound == FALSE)
		PlaySound(_TEXT("sound\\airport.wav"), NULL, SND_ASYNC);
...
void CSelectionDlg::OnSteal()
{
	...
	for (i = 0; i < STEAL_EVENT_CNT; i++)
	{
		...
		{
			str.Format(_TEXT("%s"), random_steal_event[i].msg);
			// cash decrease
			if (i != 4 && i != 5) {
				str1.Format(_TEXT("俺的银子减少了%d%%。"), random_steal_event[i].ratoi);
				str += str1;
				CRijiDlg dlg(NULL, str);
				dlg.DoModal();
			...
			{
				str1.Format(_TEXT("俺的存款减少了%d%%。"), random_steal_event[i].ratoi);
				str += str1;
				str += _TEXT("，哎呀!");
				//AfxMessageBox(str);
				CRijiDlg dlg(NULL, str);
	...
	if (!(RandomNum(1000) % 25) && m_bHackActs == TRUE)
	{
		...
		else if (MyBank > 100000)
		{
			...
			if (RandomNum(20) % 3 != 0) {
				str.Format(_TEXT("黑客入侵银行网络，疯狂修改数据库，我的存款减少了%Ld"), num);
				CRijiDlg dlg(NULL, str);
				dlg.DoModal();
				MyBank -= num;
			}
			else {
				str.Format(_TEXT("黑客入侵银行网络，疯狂修改数据库，我的存款增加了%Ld"), num);
				CRijiDlg dlg(NULL, str);
				dlg.DoModal();
				MyBank += num;
...
void CSelectionDlg::RefreshDisplay()
{
	...
	m_FameDisplay.SetText(str);
	str.Format(_TEXT("%d"), MyCash);
	m_CashDisplay.SetText(str);
	str.Format(_TEXT("%d"), MyBank);
	m_BankDisplay.SetText(str);
	// display goods/house_size
	str.Format(_TEXT("%d/%d"), myTotal, myCoat);
...
void CSelectionDlg::OnExit()
{
	...
	if (AfxMessageBox(_TEXT("嗨, 再玩一把吗?"), MB_YESNO | MB_ICONQUESTION) == IDYES) {
...
void CSelectionDlg::OnWangba()
{
	...
	if (m_nVisitWangba > 2)
	{
		CRijiDlg dlg(NULL, _TEXT("村长放出话来：你别总是在网吧里鬼混，快去做正经买卖! "));
		dlg.DoModal();
		return;
	}
	if (MyCash < 15) {
		CRijiDlg dlg(NULL, _TEXT("进网吧至少身上要带15元，呵呵，取钱再来。"));
		dlg.DoModal();
	}
	else {
...
void CSelectionDlg::OnIntro()
{
	...
	if ((int)hRun <= 32)
	{
		MessageBox(_TEXT("找不到帮助文件"), _TEXT("错误"), MB_ICONERROR);
	}
...
void CSelectionDlg::OnHouseAgency()
{
	...
	if (myCoat == 140) {
		CRijiDlg dlg1(NULL, _TEXT("中介说，您的房子比局长的还大!还租房?"));
		dlg1.DoModal();
		return;
	}
	...
	if (MyCash < 30000)
	{
		CRijiDlg dlg1(NULL, _TEXT("中介说，您没有三万现金就想租房? 一边凉快去!"));
		dlg1.DoModal();
		return;
	}
	else {
		...
		{
			CRijiDlg dlg1(NULL, _TEXT("呵! 小心为妙! 传闻北京有的租房中介公司很能骗人...."));
			dlg1.DoModal();
		}
	}
}
...
void CSelectionDlg::OnNewGame()
{
	if ((40 - m_nTimeLeft) >= 3)
	{   // confirm
		if (AfxMessageBox(_TEXT("您正在玩一个游戏，要放弃它并开始新的吗?"), MB_YESNO) == IDNO)
			return;
	}
	// TODO: Add your command handler code here
	m_pDragImage = NULL;
...
//  execute file. now, the filename is _TEXT("xxx/help.html")
//
...
void CSelectionDlg::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	if (num > 12)
	{
		AfxMessageBox(_TEXT("You pressed the keyborad 12 times."));
		num = 0;
	}
...
void CSelectionDlg::OnGoShanghai()
{
	...
	case BEIJING:   //user is in Beijing, so he wants to go to shanghai
		m_City = SHANGHAI;
		GetDlgItem(IDC_LOC)->SetWindowText(_TEXT("北京市地面示意图"));
		GetDlgItem(IDC_LOC_XIZHIMEN)->SetWindowText(_TEXT("海淀大街"));
		GetDlgItem(IDC_LOC_FUXINGMEN)->SetWindowText(_TEXT("府右街"));
		GetDlgItem(IDC_LOC_JISHUITAN)->SetWindowText(_TEXT("亚运村"));
		GetDlgItem(IDC_LOC_DONGZHIMEN)->SetWindowText(_TEXT("三元西桥"));
		GetDlgItem(IDC_LOC_JIANGUOMEN)->SetWindowText(_TEXT("永安里"));
		GetDlgItem(IDC_LOC_BEIJINGZHAN)->SetWindowText(_TEXT("方 庄"));
		GetDlgItem(IDC_LOC_CHONGWENMEN)->SetWindowText(_TEXT("永定门"));
		GetDlgItem(IDC_LOC_CHANGCHUNJIE)->SetWindowText(_TEXT("玉泉营"));
		GetDlgItem(IDC_LOC_GONGZHUFEN)->SetWindowText(_TEXT("翠微路"));
		GetDlgItem(IDC_LOC_PINGGUOYUAN)->SetWindowText(_TEXT("八角西路"));
		GetDlgItem(IDC_GO_SHANGHAI)->SetWindowText(_TEXT("我要进地铁"));
		break;
	case SHANGHAI: //user is in shanghai, he wants to go back to beijing
		m_City = BEIJING;
		//GetDlgItem(IDC_BG)->EnableWindow(FALSE);
		GetDlgItem(IDC_LOC)->SetWindowText(_TEXT("北京市地铁示意图"));
		GetDlgItem(IDC_LOC_XIZHIMEN)->SetWindowText(_TEXT("西直门"));
		GetDlgItem(IDC_LOC_FUXINGMEN)->SetWindowText(_TEXT("复兴门"));
		GetDlgItem(IDC_LOC_JISHUITAN)->SetWindowText(_TEXT("积水潭"));
		GetDlgItem(IDC_LOC_DONGZHIMEN)->SetWindowText(_TEXT("东直门"));
		GetDlgItem(IDC_LOC_JIANGUOMEN)->SetWindowText(_TEXT("建国门"));
		GetDlgItem(IDC_LOC_BEIJINGZHAN)->SetWindowText(_TEXT("北京站"));
		GetDlgItem(IDC_LOC_CHONGWENMEN)->SetWindowText(_TEXT("崇文门"));
		GetDlgItem(IDC_LOC_CHANGCHUNJIE)->SetWindowText(_TEXT("长椿街"));
		GetDlgItem(IDC_LOC_GONGZHUFEN)->SetWindowText(_TEXT("公主坟"));
		GetDlgItem(IDC_LOC_PINGGUOYUAN)->SetWindowText(_TEXT("苹果园"));
		GetDlgItem(IDC_GO_SHANGHAI)->SetWindowText(_TEXT("我要逛京城"));
		break;
	default:
		break;
	}
